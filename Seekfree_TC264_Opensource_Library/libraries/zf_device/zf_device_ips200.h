...
#define IPS200_SOFT_SPI_DELAY           (5 )                                    // 软件 SPI 的时钟延时周期 数值越小 SPI 通信速率越快
#define IPS200_SCL_PIN                  (P15_4)                                 // 软件 SPI SCK 引脚
#define IPS200_SDA_PIN                  (P15_2)                                 // 软件 SPI MOSI 引脚
//====================================================软件 SPI 驱动====================================================
#else
//====================================================硬件 SPI 驱动====================================================
// 如果使用的是SPI 串口的两寸屏幕 SPI 驱动控制引脚 可以修改
...
#endif
// 如果使用的是SPI 串口的两寸屏幕 SPI 驱动控制引脚 可以修改
#define IPS200_RST_PIN_SPI              (P15_0)                                 // (SPI串口)液晶复位引脚定义
#define IPS200_DC_PIN_SPI               (P15_1)                                 // (SPI串口)液晶命令位引脚定义
#define IPS200_CS_PIN_SPI               (P15_5)                                 // (SPI串口)液晶片选引脚定义
#define IPS200_BLk_PIN_SPI              (P15_3)                                 // (SPI串口)液晶背光引脚定义
